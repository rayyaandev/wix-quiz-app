...
const quizLogic = {
  ...
  accommodationPreference: {
    ...
    4: { wildExplorer: 2, mindfulMinimalist: 1 }, // Group hostels or campsites
  ...
  // Gender question
  gender: {
    0: { socialButterfly: 1, creativeMaverick: 1 }, // Male
    1: { romanticEscapist: 1, familyConnector: 1 }, // Female
    2: { creativeMaverick: 2, socialButterfly: 1 }, // Transgender
    3: { hybridNomad: 2, mindfulMinimalist: 1 }, // Non binary
    4: { wildExplorer: 1, soulfulNomad: 1 }, // Other
  },

  // Country question (basic scoring based on region)
  country: {
    // This will be handled dynamically based on user input
    // Default scoring for international awareness
    default: { culturalConnoisseur: 1, hybridNomad: 1 },
  },

  // State/Region question
  stateRegion: {
    // This will be handled dynamically based on user input
    // Default scoring for local awareness
    default: { local: 1, familyConnector: 1 },
  },

  // Values question (tag-multiselect) - Uncommented and added scoring
  values: {
    age: { familyConnector: 1, mindfulMinimalist: 1 },
    availability: { hybridNomad: 1, wildExplorer: 1 },
    class: { mindfulMinimalist: 1, comfortTraveler: 1 },
    ...
    preferredsocialsettings: { socialButterfly: 2, creativeMaverick: 1 },
    religiousaffiliation: { soulfulNomad: 2, culturalConnoisseur: 1 },
    senseofhumour: { socialButterfly: 2, hedonist: 1 },
    sexualorientation: { socialButterfly: 1, creativeMaverick: 1 },
    substanceuse: { hedonist: 1, wildExplorer: 1 },
  },
...
const i18n = {
  en: {
    ...
    resumeQuiz: "Resume Questionnaire",
